...
//  TicTacToe
//
//  Created by Ella Wickstrom on 11/18/19.
...
class ViewController: UIViewController {
    ...
    func checkForWinner() {
        if (gridLabel0.text == gridLabel1.text && gridLabel1.text == "X" && gridLabel2.text == "X") || (gridLabel0.text == "O"  && gridLabel1.text == "O" && gridLabel2.text == "O") {
